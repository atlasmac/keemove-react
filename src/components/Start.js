...
const Start = () => {
  return (
    <div className='div start' id='start'>
      ...
      <div className='inner-div start-div'>
        <div>
          <p>
            Connection can help ❤️. Both adults and children crave connection during all seasons of life. 
            So, if you or your child are working through a difficult season, focus on your connection with each other. 
            Offer a hug, spend quality time, or provide positive affirmations. 
            That makes it easier for you to make positive changes in your family’s everyday routine. 
          </p>
        </div>
