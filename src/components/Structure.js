      ...
      <div className='inner-div consultation'>
        ...
        <div className='con-div'>
          ...
          <ul>
            ...
            <li>Sensory sensitivities (e.g. prefers seated activities and dislike movement)</li>
            <li>Craves a lot of sensory input (e.g. could swing on the swing all day)</li>
            <li>Difficult sleeping</li>
            <li>Frequent outbursts</li>
          </ul>
